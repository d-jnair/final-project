==================================================================================
README: Information on Attributes for NASA FIRMS MODIS or VIIRS Fire/Hotspot Data
==================================================================================

For a list of attribute fields for the MODIS data: 
  https://www.earthdata.nasa.gov/data/tools/firms/active-fire-data-attributes-modis-viirs#toc-attribute-fields-for-nrt-modis-active-fire-data

For a list of attribute fields for the VIIRS data: 
  https://www.earthdata.nasa.gov/data/tools/firms/active-fire-data-attributes-modis-viirs#toc-attribute-fields-for-nrt-viirs-375m-active-fire-data

For the key differences between the NRT and standard products visit:   
  https://www.earthdata.nasa.gov/data/tools/firms/faq#heading-accordion-124369-3

Use the Collection / Version field to distinguish between NRT and standard data.

Visit the NASA FIRMS project website at http://earthdata.nasa.gov/firms and see https://firms.modaps.eosdis.nasa.gov/resources/
...
Data Use Guidance & Disclaimer - see: https://www.earthdata.nasa.gov/data/tools/firms
